...
{    
    ...
    [SerializeField] float hoverStrength = 10f; // How much the enemy bounces back after getting below the hover height (this makes them 'flap' in place)

    public override void Move(){
        RaycastHit hit;
        // Use a raycast to work out the hover height
